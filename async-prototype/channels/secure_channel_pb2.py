...
_REMOTEVALUE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="value",
            full_name="securechannel.RemoteValue.value",
            index=0,
            number=1,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="rendezvous_key",
            full_name="securechannel.RemoteValue.rendezvous_key",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="session_id",
            full_name="securechannel.RemoteValue.session_id",
            index=2,
            number=3,
            type=3,
            cpp_type=2,
...
_KEYVALUE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="rendezvous_key",
            full_name="securechannel.KeyValue.rendezvous_key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="session_id",
            full_name="securechannel.KeyValue.session_id",
            index=1,
            number=2,
            type=3,
            cpp_type=2,
...
_VALUE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="value",
            full_name="securechannel.Value.value",
            index=0,
            number=1,
            type=2,
            cpp_type=6,
...
RemoteValue = _reflection.GeneratedProtocolMessageType(
    "RemoteValue",
    (_message.Message,),
    {
