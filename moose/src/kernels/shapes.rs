...
modelled_kernel! {
    ...
    [
        ...
        (HostPlacement, vec[HostBitTensor] -> HostBitTensor => [runtime] attributes[axis] Self::bit_kernel),
        ...
        (ReplicatedPlacement, vec[BooleanTensor] -> BooleanTensor => [concrete] attributes[axis] Self::bool_rep_kernel),
        ...
        (ReplicatedPlacement, vec[ReplicatedBitTensor] -> ReplicatedBitTensor => [concrete] attributes[axis] Self::rep_rep_kernel),
