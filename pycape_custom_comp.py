...
class Result:
  def __init__(self, placement, named=None):
    self.placement = placement
    self.name = named or "output"

Result = NewType("Result", Result)
...
def place_outputs(output_placements):
  def wrapper(abstract_computation):
