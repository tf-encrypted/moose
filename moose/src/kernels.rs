...
kernel! {
    ...
    [
        ...
        (HostPlacement, (Fixed64Tensor, Fixed64Tensor) -> BoolTensor => [hybrid] Self::fixed_kernel),
        (HostPlacement, (Fixed128Tensor, Fixed128Tensor) -> BoolTensor => [hybrid] Self::fixed_kernel),
        ...
        (ReplicatedPlacement, (Fixed64Tensor, Fixed64Tensor) -> BoolTensor => [hybrid] Self::fixed_rep_kernel),
        (ReplicatedPlacement, (Fixed128Tensor, Fixed128Tensor) -> BoolTensor => [hybrid] Self::fixed_rep_kernel),
