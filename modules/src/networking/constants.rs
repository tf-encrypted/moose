...
lazy_static! {
    ...
    pub(crate) static ref MAX_ELAPSED_TIME: Option<Duration> = Some(Duration::from_millis(1_000));
    /// The default maximum back off time in milliseconds (3600 seconds).
    pub(crate) static ref MAX_INTERVAL_MILLIS: Duration = Duration::from_millis(3_600_000);
}
