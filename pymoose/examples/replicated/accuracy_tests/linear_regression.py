...
def benchmark(X_train, y_train, X_test, y_test):
    ...
    actual_result = actual_result.reshape((n_sample_test, -1))
...
if __name__ == '__main__':
    ...
    for noise in noise_level:
        # create dataset
        X_train, y_train = make_regression(n_samples=n_sample_train, n_features=n_features, n_informative=n_informative, n_targets=3, noise=noise, random_state=random_state)
        X_test, y_test = make_regression(n_samples=n_sample_test, n_features=n_features, n_informative=n_informative, n_targets=3, noise=noise, random_state=random_state)
