...
impl RepAddOp {
        ...
        HostPlacement: PlacementAdd<C, R, R, Output = R>,
    {
        ...
        let z00 = with_context!(player0, x00 + y00);
        let z10 = with_context!(player0, x10 + y10);

        let z11 = with_context!(player1, x11 + y11);
        let z21 = with_context!(player1, x21 + y21);

        let z22 = with_context!(player2, x22 + y22);
        let z02 = with_context!(player2, x02 + y02);
...
impl RepMulOp {
        ...
        ReplicatedPlacement: PlacementZeroShare<C, K, R>,
    {
        ...
        let z0 = with_context!(player0, x00 * y00 + x00 * y10 + x10 * y00 + a0);
        let z1 = with_context!(player1, x11 * y11 + x11 * y21 + x21 * y11 + a1);
        let z2 = with_context!(player2, x22 * y22 + x22 * y02 + x02 * y22 + a2);
