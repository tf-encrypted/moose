...
modelled_kernel! {
    ...
    [
        ...
        (HostPlacement, () -> crate::logical::Tensor => [concrete] Self::logical_kernel(sig)),
        ...
        (HostPlacement, () -> HostFixed128AesTensor => [concrete] Self::host_fixed_aestensor(sig)),
        ...
        (ReplicatedPlacement, () -> ReplicatedFixed64Tensor => [concrete] Self::replicated_fixed_kernel(sig)),
        (ReplicatedPlacement, () -> ReplicatedFixed128Tensor => [concrete] Self::replicated_fixed_kernel(sig)),
