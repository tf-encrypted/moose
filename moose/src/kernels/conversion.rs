...
modelled_kernel! {
    ...
    [
        ...
        (HostPlacement, (HostBitTensor) -> HostFloat64Tensor => [runtime] Self::bool_float_host_kernel),
        (HostPlacement, (HostBitTensor) -> HostFloat32Tensor => [runtime] Self::bool_float_host_kernel),
