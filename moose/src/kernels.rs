...
modelled_kernel! {
    ...
    [
        ...
        (HostPlacement, () -> Unit => [runtime] Self::missing_kernel),
        (HostPlacement, () -> HostShape => [runtime] Self::kernel),
        (HostPlacement, () -> Seed => [runtime] Self::kernel),
        ...
        (HostPlacement, () -> crate::logical::Tensor => [concrete] Self::logical_kernel => capturing(sig)),
        ...
        (HostPlacement, () -> HostFixed128AesTensor => [concrete] Self::host_fixed_aestensor => capturing(sig)),
        ...
        (ReplicatedPlacement, () -> ReplicatedFixed64Tensor => [concrete] Self::replicated_fixed_kernel => capturing(sig)),
        (ReplicatedPlacement, () -> ReplicatedFixed128Tensor => [concrete] Self::replicated_fixed_kernel => capturing(sig)),
