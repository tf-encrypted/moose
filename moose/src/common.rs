...
use crate::computation::{
    AdditivePlacement, HostPlacement, HostReshapeOp, KnownType, Placed, ReplicatedPlacement,
    RingInjectOp, ShapeOp,
};
use crate::floatingpoint::{Float32Tensor, Float64Tensor};
use crate::host::{
    HostBitTensor, HostEncFixed128Tensor, HostFloat32Tensor, HostFloat64Tensor, HostInt16Tensor,
...
modelled!(PlacementShape::shape, HostPlacement, (HostEncFixed128Tensor) -> HostShape, ShapeOp);
...
kernel! {
    ...
    [
        ...
        (HostPlacement, (HostEncFixed128Tensor) -> HostShape => [runtime] Self::hostencfixed_kernel),
