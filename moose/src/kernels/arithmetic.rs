...
modelled_kernel! {
    ...
    [
        ...
        (HostPlacement, (Ring64Tensor, Ring64Tensor) -> Ring64Tensor => [concrete] Self::ring64_host_kernel),
        ...
        (ReplicatedPlacement, (Ring64Tensor, Ring64Tensor) -> Ring64Tensor => [concrete] Self::ring64_rep_kernel),
