"""
This script benchmarks accuracy of linear regression against Sklearn to test
if loss of precision occurs.  Local computations, replicated, no aes encryption
"""
