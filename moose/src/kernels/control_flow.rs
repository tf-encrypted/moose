...
modelled!(PlacementMux::mux, HostPlacement, (Tensor, Tensor, Tensor) -> Tensor, MuxOp);
...
modelled!(PlacementMux::mux, HostPlacement, (HostBitTensor, HostInt64Tensor, HostInt64Tensor) -> HostInt64Tensor, MuxOp);
modelled!(PlacementMux::mux, HostPlacement, (HostBitTensor, HostInt32Tensor, HostInt32Tensor) -> HostInt32Tensor, MuxOp);
modelled!(PlacementMux::mux, HostPlacement, (HostBitTensor, HostInt16Tensor, HostInt16Tensor) -> HostInt16Tensor, MuxOp);
